...
def seed_data():
    ...
    try:
        ...
        doctors_data = [
            {"name": "刘武", "title": "副主任医师", "department_id": 1, "hospital": "浙江大学医学院附属第一医院", "specialty": "湿疹、痤疮、皮肤过敏、荨麻疹", "rating": 5.0, "monthly_answers": 617, "avg_response_time": "8分钟", "can_prescribe": True, "is_top_hospital": True, "is_ai": True, "is_active": True, "ai_model": "qwen-plus", "ai_temperature": 0.7},
            {"name": "李明", "title": "主任医师", "department_id": 2, "hospital": "北京儿童医院", "specialty": "小儿感冒、发热、腹泻、生长发育", "rating": 5.0, "monthly_answers": 892, "avg_response_time": "10分钟", "can_prescribe": True, "is_top_hospital": True, "is_ai": True, "is_active": True, "ai_model": "qwen-plus", "ai_temperature": 0.7},
            {"name": "张丽", "title": "主任医师", "department_id": 3, "hospital": "北京协和医院", "specialty": "妇科炎症、月经不调、不孕不育", "rating": 5.0, "monthly_answers": 723, "avg_response_time": "6分钟", "can_prescribe": True, "is_top_hospital": True, "is_ai": True, "is_active": True, "ai_model": "qwen-plus", "ai_temperature": 0.7},
            {"name": "赵强", "title": "主任医师", "department_id": 4, "hospital": "北京大学第一医院", "specialty": "胃炎、胃溃疡、肠炎、肝病", "rating": 5.0, "monthly_answers": 634, "avg_response_time": "5分钟", "can_prescribe": True, "is_top_hospital": True, "is_ai": True, "is_active": True, "ai_model": "qwen-plus", "ai_temperature": 0.7},
            {"name": "孙伟", "title": "副主任医师", "department_id": 5, "hospital": "中日友好医院", "specialty": "感冒、咳嗽、支气管炎、肺炎", "rating": 4.9, "monthly_answers": 521, "avg_response_time": "6分钟", "can_prescribe": True, "is_top_hospital": True, "is_ai": True, "is_active": True, "ai_model": "qwen-plus", "ai_temperature": 0.7},
            {"name": "周华", "title": "主任医师", "department_id": 6, "hospital": "北京阜外医院", "specialty": "高血压、冠心病、心律失常、心衰", "rating": 5.0, "monthly_answers": 412, "avg_response_time": "8分钟", "can_prescribe": True, "is_top_hospital": True, "is_ai": True, "is_active": True, "ai_model": "qwen-plus", "ai_temperature": 0.7},
            {"name": "吴敏", "title": "副主任医师", "department_id": 7, "hospital": "北京协和医院", "specialty": "糖尿病、甲亢、甲减、骨质疏松", "rating": 4.9, "monthly_answers": 378, "avg_response_time": "7分钟", "can_prescribe": True, "is_top_hospital": True, "is_ai": True, "is_active": True, "ai_model": "qwen-plus", "ai_temperature": 0.7},
            {"name": "郑刚", "title": "主任医师", "department_id": 8, "hospital": "首都医科大学宣武医院", "specialty": "头痛、失眠、中风、帕金森病", "rating": 5.0, "monthly_answers": 289, "avg_response_time": "10分钟", "can_prescribe": True, "is_top_hospital": True, "is_ai": True, "is_active": True, "ai_model": "qwen-plus", "ai_temperature": 0.7},
            {"name": "钱进", "title": "副主任医师", "department_id": 9, "hospital": "北京积水潭医院", "specialty": "骨折、关节炎、颈椎病、腰椎病", "rating": 4.9, "monthly_answers": 445, "avg_response_time": "6分钟", "can_prescribe": True, "is_top_hospital": True, "is_ai": True, "is_active": True, "ai_model": "qwen-plus", "ai_temperature": 0.7},
            {"name": "冯雪", "title": "主任医师", "department_id": 10, "hospital": "北京同仁医院", "specialty": "近视、白内障、青光眼、干眼症", "rating": 5.0, "monthly_answers": 356, "avg_response_time": "8分钟", "can_prescribe": True, "is_top_hospital": True, "is_ai": True, "is_active": True, "ai_model": "qwen-plus", "ai_temperature": 0.7},
            {"name": "蒋云", "title": "副主任医师", "department_id": 11, "hospital": "北京同仁医院", "specialty": "中耳炎、鼻炎、咽喉炎、耳鸣", "rating": 4.9, "monthly_answers": 298, "avg_response_time": "7分钟", "can_prescribe": True, "is_top_hospital": True, "is_ai": True, "is_active": True, "ai_model": "qwen-plus", "ai_temperature": 0.7},
            {"name": "沈洁", "title": "主治医师", "department_id": 12, "hospital": "北京口腔医院", "specialty": "牙痛、龋齿、牙周病、智齿", "rating": 4.8, "monthly_answers": 234, "avg_response_time": "5分钟", "can_prescribe": False, "is_top_hospital": True, "is_ai": True, "is_active": True, "ai_model": "qwen-plus", "ai_temperature": 0.7},
        ]
